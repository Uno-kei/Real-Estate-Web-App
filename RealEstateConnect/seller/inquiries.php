...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_status') {
    ...
    if ($inquiryId > 0 && in_array($status, ['pending', 'responded', 'scheduled', 'completed', 'rejected'])) {
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0" style="width: 50px; height: 50px; background-image: url('<?= $inquiry['property_image'] ?? '../img/property-placeholder.jpg' ?>'); background-size: cover; background-position: center;"></div>
                                                    <div class="ms-3">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <form method="POST" action="inquiries.php">
                                                                ...
                                                                <button type="submit" class="dropdown-item text-danger">Reject Inquiry</button>
                                                            </form>
                                                        </li>
                                                    </ul>
                                                </div>
